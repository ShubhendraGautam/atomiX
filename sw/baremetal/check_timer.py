#!/usr/bin/env python3
"""Run the timer interrupt image on ISS, QEMU, and the complete RTL SoC."""
import subprocess
import sys
...
def main() -> None:
    elf = ROOT / "sw/baremetal/build/timer.elf"
    image = ROOT / "sw/baremetal/build/timer.hex"
    ...
    run("RTL", ["make", "-s", "--no-print-directory", "-C",
                ...
                "RESET_PC=0x80000000"])
    print("[baremetal] timer: PASS on ISS, QEMU, and RTL")
